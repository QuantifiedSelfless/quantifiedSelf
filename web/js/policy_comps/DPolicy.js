        ...
        return (
          <div className="clearfix"> 
            <div className="col-10 mx-auto white">
                ...
                <p>The show uses attendee's own data to generate the art and dictate the experience. Thus, to participate in the experience, users are asked to connect through one or more their email and social media accounts, in keeping with the articles set forth in these Terms and Conditions (hereafter the 'Terms'). Users also have the choice to not share information or tell us they do not use certain online services. The only consequence of not sharing is for free performances, when tickets are limited, we may prefer users who share more since it will improve the quality of the show.</p>
                ...
                <p>To make it possible to personalize the performance and exhibit that is offered the night of the user's attendance, after deciding to book a ticket, the user is asked to share their name and surname, and then to share access their data owned by third-party services. We DO NOT store the entirety of the user's shared dataset, but rather build a profile on the user similar to a cookie tracking service and only store select data relevant to specific exhibits for the night you attend. This is done by:</p>
                <ul>
                    <li>Logging in via the user's Gmail, Facebook, Twitter, Instagram, Reddit, Spotify, and/or Tumblr account.</li>
                ...
                <p>Due to the characteristics of the Internet, particulary the fact that the staff and sponsors of Quantified Self cannot ensure every user is using proper security precautions, Quantified Self's staff and sponsors will in no event be held liable for damages of any kind, whether accidental or suffered by the user or third parties, and whether caused or not by third parties.</p>
                ...
                <ol>
                    ...
                    <li>Your data will never be subject to any commercial, promotional, or third-party use of any kind. We will never share your data unless ordered by force of law.</li>
                    <li>All personal data will be deleted at the end of the performance the night you attend.</li>
                    <li>We use standard filters to automatically remove sensitive data (eg, account numbers, phone numbers) accidentally incurred; however, names, images, interests and other profile-based data will be used during the performance.</li>
                </ol>
                ...
                <p>These Terms are governed by the laws of the United States of America. In the case of dispute, we are located in the city of Boulder, Boulder County, Colorado, United States of America and thus are subject to the courts of their jurisdiction.</p>
