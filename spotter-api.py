...
#application = linkedin.LinkedInApplication(token='AQUmaCNHq7zdK-7x5Id00nAeKyLrjojHwcVIMnfkIJYA_zUmK-4DQkfy57Y9o_mwsz_zptZKfP382y1jECbcO9PYISlacjQTuEjb5OfhWaJS2hRR9IzaBGBCuBjyZ10et2aalEzhc1_7TZVxAznnqXlenzrMnUkAHV-mxgmpMR4QP9tEYZs')
#print application.get_profile()
#r.connect("localhost", 28015).repl()
#r.db("test").table_create('user_profiles').run();
#r.table('user_profiles').insert(application.get_profile()).run();
