...
class TumblrAuth(OAuthRequestHandler):
    ...
    def handleAuthCallBack(self, code, user_id):
        ...
        self._ioloop.add_callback(save_token, provider="tumblr", user_id=user_id, token_data={"access_token":access_info['oauth_token'],"access_token_secret":access_info["oauth_token_secret"]})
