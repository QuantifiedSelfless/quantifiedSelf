        ...
        return (
            <div className=" clearfix white">
                <div className="col-10 mx-auto">
                    ...
                    <p>Our theater and art production creates a profile on you similar to the way your online services do. In order to achieve this we ask that you authorize our service through as many of your social media and online platforms as possible. Since our production is meant to give you an experience to help understand what your data says about you and how it's used, your sharing makes the performance better. Per our policy, we never share or sell any of your data and we delete it immediately after the night you attend our show. If you do not get a ticket, for some reason, but share data, we will delete immediately upon recognition that you will not be attending.</p>
                   ...
                   <a href="/signup#user">
                    <button className="btn btn-primary m3 b1 bg-blue">Agree</button>
                    </a>
                </div>
            </div>
        );
